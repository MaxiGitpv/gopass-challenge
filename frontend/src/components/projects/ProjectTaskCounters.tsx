...
/** Badges de conteo por estado — reutilizable en dashboard y detalle de proyecto */
  ...
  return (
    <div className="mt-3 flex flex-wrap gap-2">
      {items.map(({ key, label, color }) => (
        <span
          key={key}
          className={`inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs ${color}`}
        >
